...
* For Developer  
  ...
  * `scala_version` should be 2.13.6 because this project contains binary of Scala 2.13.6. Make sure your version matches the version this mod provides. See [this file](https://github.com/Kotori316/SLP/blob/1.16/gradle.properties)
  * `scala_major` must be 2.13.
  ...
  dependencies {
    ...
    implementation(group: 'com.kotori316', name: 'ScalableCatsForce'.toLowerCase(Locale.ROOT), version: '2.13.6-build-1', classifier: 'dev')
  }
  ```
  ...
  * See [`ScalaModObject.scala`](https://github.com/Kotori316/SLP/blob/1.17/src/main/scala/com/kotori316/scala_lib/example/ScalaModObject.scala) and [`mods.toml`](https://github.com/Kotori316/SLP/blob/1.16/src/main/resources/META-INF/mods.toml) in this project.
