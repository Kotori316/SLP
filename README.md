...
* For Developer  
  ...
  dependencies {
      ...
      compileOnly(group: 'org.typelevel', name: "cats-core_${scala_major}", version: '2.6.2-kotori')
  ...
  * `scala_version` should be 2.13.7 because this project contains binary of Scala 2.13.7. Make sure your version
