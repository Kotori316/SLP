...
base {
    archivesName = "slp_example_26.3.0"
}
...
val forgeJarJarOutput: Provider<RegularFile> = project(":forge-26.3.0").tasks
    .named("jarJar", org.gradle.jvm.tasks.Jar::class)
    .flatMap { it.archiveFile }

dependencies {
    implementation(minecraft.dependency(libs.forge263000))
